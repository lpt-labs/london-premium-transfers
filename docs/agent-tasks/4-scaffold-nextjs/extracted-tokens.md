...
Moved to [`decisions.md`](decisions.md) (entries dated 2026-05-20: *Tailwind v4 token sync*, *Token naming*, *Font loading via next/font/google*). This file is now pure design provenance — colour/font/spacing values and their source. Implementation decisions live next door.
